...
class GO2_TrottoHandstand_Cfg( LeggedRobotCfg ):
    ...
    class env:
        ...
        single_num_privileged_obs = 68  #51 不平衡的观测，包含了特权信息，正常传感器获得不到的信息
...
class GO2_TrottoHandstand_PPO(LeggedRobotCfgPPO):
    ...
    class algorithm:
        ...
        obs_permutation = [-0.0001, -1, 2, -3, 4,-5,
                           ...
                           -41, 42, -43, -44, 45, -46]
        # act_permutation = [-6, -7, 8, 9, 10, -11, -0.0001, -1, 2, 3, 4, -5]#关节电机的对称关系
        act_permutation = [-3, 4, 5,-0.0001, 1, 2 , -9, 10, 11,-6, 7, 8,]#关节电机的对称关系
        frame_stack = 10
        sym_coef = 1.0
    class runner:
