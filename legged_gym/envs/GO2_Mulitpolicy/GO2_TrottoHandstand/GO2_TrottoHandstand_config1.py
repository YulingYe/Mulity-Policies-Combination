...
class GO2_TrottoHandstand_Cfg( LeggedRobotCfg ):
    class env:
        ...
        frame_stack = 1 #action stack tort 3
        c_frame_stack = 1 #critic 网络的堆叠帧数 tort3
        num_envs = 4096
        num_single_obs = 48 #这个是传感器可以获得到的信息 trot:47
    ...
    class asset:
        ...
        feet_name_reward=['FL_foot', 'FR_foot']  # handstand
        contact_foot=['RL_foot', 'RR_foot']  # handstand
        target_gravity=[-1.0, 0.0, 0.0]   # handstand
        threshold=5.0     # handstand
        self_collisions = 0 # 1 to disable, 0 to enable...bitwise filter   # handstand
