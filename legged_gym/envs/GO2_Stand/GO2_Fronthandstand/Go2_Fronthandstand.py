...
from legged_gym.envs.GO2_Stand.GO2_Fronthandstand.Go2_Fronthandstand_Config import GO2Cfg_Fronthandstand,GO2CfgPPO_Fronthandstand

class Go2_Fronthandstand(BaseTask):
    def __init__(self, cfg: GO2Cfg_Fronthandstand, sim_params, physics_engine, sim_device, headless):
