...
class GO2_Trot_Robot(BaseTask):
    def __init__(self, cfg: GO2_Trot_Cfg_Yu, sim_params, physics_engine, sim_device, headless):
        ...
        self.total_steps = 0 # 迭代步长初始化
        self.saved_searching_ternimal_states_list = [] # 终止状态列表初始化
        
        self.saved_searching_ternimal_states_index_list = [] # 终止状态列表系数初始化
    ...
    def reset_idx(self, env_ids):
        ...
        #  save the terminal state 保存终止状态
        # self.saved_searching_ternimal_state = self.root_states.clone()[self.lego_indices.view(-1), :].view(self.num_envs, 132, 13)
