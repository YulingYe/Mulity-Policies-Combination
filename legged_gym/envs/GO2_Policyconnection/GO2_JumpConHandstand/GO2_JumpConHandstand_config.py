...
class GO2_JumpConHandstand_Cfg( LeggedRobotCfg ):
...
class GO2_JumpConHandstand_PPO(LeggedRobotCfgPPO):
    seed = 1
    ...
    class runner:
        ...
        experiment_name = 'go2_jumpconhandstand'
        run_name = ''
        # load and resume
        resume = False
